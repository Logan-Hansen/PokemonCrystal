	...
	const AZALEATOWN_FRUIT_TREE2
	const AZALEATOWN_FRUIT_TREE3
...
GreenApricornTree:
	fruittree FRUITTREE_AZALEA_TOWN2

RedApricornTree:
	fruittree FRUITTREE_AZALEA_TOWN3
...
AzaleaTown_MapEvents:
	...
	object_event  7,  2, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, GreenApricornTree, -1
	object_event  8,  2, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, WhiteApricornTree, -1
	object_event  9,  2, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, RedApricornTree, -1
