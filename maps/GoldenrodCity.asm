...
GoldenrodCityMoveTutorCallback:
	...
	;changed to make MoveTutor always here
	readvar VAR_WEEKDAY
...
.MoveMenuHeader:
	...
	menu_coords 0, 2, 15, TEXTBOX_Y - 1 ;if add a 4th move remove the -1
	dw .MenuData
	db 1 ; default option
...
.TeachMove:
	...
	waitbutton
	closetext
	; tutor nolonger goes inside so you can buy multiple
	end
	;readvar VAR_FACING
...
GoldenrodCity_MapEvents:
	...
	object_event 15, 16, SPRITE_GRAMPS, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, SwarmGrampsScript, EVENT_GOLDENROD_CITY_CIVILIANS
