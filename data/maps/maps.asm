...
MapGroup_Cinnabar:
	...
	map SeafoamIslands, TILESET_ICE_PATH, CAVE, LANDMARK_SEAFOAM_ISLANDS, MUSIC_DARK_CAVE, TRUE, PALETTE_NITE, FISHGROUP_DRATINI
	map PokemonMansion, TILESET_TOWER, DUNGEON, LANDMARK_CINNABAR_ISLAND, MUSIC_BURNED_TOWER, TRUE, PALETTE_NITE, FISHGROUP_SHORE
...
MapGroup_Viridian:
	...
	map ViridianForest, TILESET_FOREST, FOREST, LANDMARK_ROUTE_2, MUSIC_UNION_CAVE, FALSE, PALETTE_NITE, FISHGROUP_POND
