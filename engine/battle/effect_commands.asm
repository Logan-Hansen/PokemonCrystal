...
.got_species
	...
	pop bc
	ret nz
; fix for ditto metal powder increasing damage taken
	ld h, b
	ld l, c
	srl b
	rr c
...
.special
	...
	call SandstormSpDefBoost ; SpDefBoost for rock during sandstorm
...
.finish
; fixed reflect and light screen stat wrap in multiplayer
...
; Double the stat
	sla l
	rl h
	; fix for thick club and light ball stat wrap
	ld a, HIGH(MAX_STAT_VALUE)
	cp h
	jr c, .cap
	ret nz
...
BattleCommand_FreezeTarget:
	...
	cp WEATHER_SUN
	ret z
	ld a, ICE ; Don't freeze/frostbite an Ice-type
	call CheckIfTargetIsGivenType
	ret z
	call GetOpponentItem
	ld a, b
...
BattleCommand_ParalyzeTarget:
	...
	ld a, ELECTRIC ; Don't paralyze an electric-type gen 6+ style
	call CheckIfTargetIsGivenType
	ret z
