...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move DOUBLESLAP,   EFFECT_MULTI_HIT,          18, NORMAL,        85, 10,   0
	...
	move BLIZZARD,     EFFECT_FREEZE_HIT,        120, ICE,           80, 10,  10
	...
	move SOLARBEAM,    EFFECT_SOLARBEAM,         125, GRASS,        100, 10,   0
	...
	move EGG_BOMB,     EFFECT_NORMAL_HIT,        100, GRASS,        90, 10,   0
	...
	move WATERFALL,    EFFECT_FLINCH_HIT,         85, WATER,        100, 15,  20
	...
	move CONSTRICT,    EFFECT_SPEED_DOWN_HIT,     15, NORMAL,       100, 35,  10
	...
	move SKY_ATTACK,   EFFECT_SKY_ATTACK,        140, FLYING,       100, 10,   0
	...
	move SPIDER_WEB,   EFFECT_MEAN_LOOK,           0, BUG,          100, 15,   0
	...
	move SLUDGE_BOMB,  EFFECT_POISON_HIT,         95, POISON,       100, 15,  15
	...
	move PERISH_SONG,  EFFECT_PERISH_SONG,         0, NORMAL,       100, 10,   0
	...
	move STEEL_WING,   EFFECT_DEFENSE_UP_HIT,     70, STEEL,        100, 35,  10
	...
	move PRESENT,      EFFECT_PRESENT,             1, NORMAL,        95, 15,   0
	...
	move METAL_CLAW,   EFFECT_ATTACK_UP_HIT,      70, STEEL,        100, 35,  10
	...
	move CROSS_CHOP,   EFFECT_NORMAL_HIT,        100, FIGHTING,      90, 10,   0
	move TWISTER,      EFFECT_TWISTER,            70, DRAGON,       100, 20,  20
	move RAIN_DANCE,   EFFECT_RAIN_DANCE,          0, WATER,         90, 15,   0
	move SUNNY_DAY,    EFFECT_SUNNY_DAY,           0, FIRE,          90, 15,   0
	move CRUNCH,       EFFECT_SP_DEF_DOWN_HIT,    85, DARK,         100, 15,  20
