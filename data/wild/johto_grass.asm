...
JohtoGrassWildMons:
	...
	;  %, species,		min, max
	db 16, VENONAT, 	 10,  13
	db 20, SPINARAK, 	 12,  14
	db 24, PSYDUCK, 	 12,  14
	db 40, HOOTHOOT, 	 13,  15
	db  0, RATTATA, 	  5,   5
	db  0, RATTATA, 	  5,   5
	db  0, RATTATA, 	  5,   5	
	end_grass_wildmons
	...
	; morn
	;  %, species,		min, max
	db 24, GROWLITHE, 	 12,  14
	db 24, SNUBBULL, 	 12,  14
	db 31, PIDGEY, 	 	 12,  14
	db 12, ABRA, 	 	 12,  14
	db  4, JIGGLYPUFF, 	 12,  14
	db  4, DITTO, 		 12,  14
	db  1, YANMA, 		 12,  14
	...
	;  %, species,		min, max
	db 24, ABRA, 	 	 12,  14
	db 12, JIGGLYPUFF, 	 12,  14
	db  4, DITTO, 		 12,  14
	db  1, YANMA, 		 12,  14
	db 20, PSYDUCK, 	 12,  14
	db 12, DROWZEE, 	 12,  14
	db 27, HOOTHOOT, 	 12,  14	
	end_grass_wildmons
