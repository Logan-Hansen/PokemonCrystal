...
; Johto story events
	...
	const EVENT_GOT_A_CHINCHOU_FROM_TIM ;unused EVENT_MANIA_TOOK_SHUCKIE_OR_LET_YOU_KEEP_HIM ; now mine
...
; Phone events
	...
	const EVENT_SEAFOAM_ISLANDS_ARTICUNO;mine
...
; Lass
	...
	const EVENT_BEAT_LASS_STAUNEY ; custom
; Hiker
