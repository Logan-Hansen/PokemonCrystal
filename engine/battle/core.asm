...
; fix for perish song and spikes leaving pokemon alive with 0 HP
HasAnyoneFainted:
...
; fix for perish song and spikes leaving alive with 0HP
.faint_loop
	call .Function
	ret c
	call HasAnyoneFainted
...
GetWeatherImage:
	...
	cp WEATHER_RAIN ;tutorial says could optimze this as dec a instead
	jr z, .done
	ld de, SunWeatherImage
	ld b, PAL_BATTLE_OB_YELLOW
	cp WEATHER_SUN ;tutorial says could optimze this as dec a instead
	jr z, .done
