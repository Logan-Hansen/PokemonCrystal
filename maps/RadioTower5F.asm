...
RadioTower5F_MapScripts:
	...
	def_callbacks
	callback MAPCALLBACK_NEWMAP, HideGiovanniCallback
...
RadioTower5F_MapEvents:
	...
	object_event 23, 13, SPRITE_GIOVANNI, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_SCRIPT, 0, ObjectEvent, -1
