...
SECTION "Enemy Trainer Parties 1", ROMX
 ...
 FalknerGroup:
	...
	db 9, NOCTOWL,		TACKLE, MUD_SLAP, PECK, NO_MOVE
...
WhitneyGroup:
	...
	db 17, IGGLYBUFF,  CHARM, DIZZY_PUNCH, POUND, NO_MOVE
	db 18, FURRET,	   QUICK_ATTACK, FURY_SWIPES, CURSE, HEADBUTT
...
BugsyGroup:
	...
	db 14, SPINARAK,   POISON_STING, SCARY_FACE, LEECH_LIFE, NO_MOVE
	db 14, METAPOD,    TACKLE, STRING_SHOT, HARDEN, NO_MOVE
	db 14, LEDYBA,	   TACKLE, COMET_PUNCH, SUPERSONIC, NO_MOVE
	db 14, KAKUNA,     POISON_STING, STRING_SHOT, HARDEN, NO_MOVE   
	db 16, SCYTHER,    QUICK_ATTACK, PURSUIT, FURY_CUTTER, LEER
	db -1 ; end

MortyGroup:
	; MORTY (1)
	db "MORTY@", TRAINERTYPE_MOVES
	db 21, GASTLY,     LICK, SPITE, SMOG, CURSE
	db 21, HAUNTER,    HYPNOSIS, SMOG, CURSE, NIGHT_SHADE
	db 23, MISDREAVUS, PSYWAVE, LICK, CONFUSE_RAY, SPITE
	db 23, HAUNTER,    SPITE, LICK, SMOG, NIGHT_SHADE
