...
SECTION "Enemy Trainer Parties 1", ROMX
 ...
 FalknerGroup:
	...
	db 8, PIDGEY, 		TACKLE, MUD_SLAP, SAND_ATTACK, GUST
	db 8, HOOTHOOT,     TACKLE, MUD_SLAP, GROWL, PECK
	db 9, PIDGEOTTO,	TACKLE, MUD_SLAP, GUST, SAND_ATTACK
	db 9, NOCTOWL,		TACKLE, MUD_SLAP, PECK, GROWL
...
WhitneyGroup:
	...
	db 18, JIGGLYPUFF, CHARM, DIZZY_PUNCH, POUND, SING
	db 19, TEDDIURSA,  SCRATCH, LEER, SEISMIC_TOSS, FURY_SWIPES
	db 19, FURRET,	   QUICK_ATTACK, FURY_SWIPES, CURSE, HEADBUTT
...
BugsyGroup:
	...
	db 15, SPINARAK,   POISON_STING, SCARY_FACE, LEECH_LIFE, CONSTRICT
	db 15, BUTTERFREE, CONFUSION, STUN_SPORE, LEECH_LIFE, GUST
	db 16, LEDIAN,	   TACKLE, COMET_PUNCH, SUPERSONIC, NO_MOVE
	db 16, BEEDRILL,   POISON_STING, FURY_ATTACK, HARDEN, TWINEEDLE   
	db 17, SCYTHER,    QUICK_ATTACK, PURSUIT, FURY_CUTTER, LEER
	db -1 ; end

MortyGroup:
	; MORTY (1)
	db "MORTY@", TRAINERTYPE_MOVES
	db 22, GASTLY,     LICK, SPITE, SMOG, CURSE
	db 22, HAUNTER,    SPITE, SMOG, LICK, NIGHT_SHADE
	db 23, MISDREAVUS, PSYWAVE, SHADOW_BALL, CONFUSE_RAY, SPITE
	db 23, HAUNTER,    HYPNOSIS, LICK, SMOG, NIGHT_SHADE
...
PryceGroup:
	...
	db 34, DEWGONG,    HEADBUTT, REST, AURORA_BEAM, HAIL
	db 34, SNEASEL,    FAINT_ATTACK, ICY_WIND, QUICK_ATTACK, ICE_PUNCH
	db 34, CLOYSTER,   BUBBLEBEAM, AURORA_BEAM, HAIL, SPIKES
	db 35, DELIBIRD,   PRESENT, HAIL, AURORA_BEAM, FLY
	db 38, PILOSWINE,  ICY_WIND, EARTHQUAKE, HAIL, BLIZZARD
	db -1 ; end
...
JasmineGroup:
	...
	db 31, SKARMORY,   STEEL_WING, SWIFT, AGILITY, WING_ATTACK
	db 31, MAGNETON,   THUNDERBOLT, SUPERSONIC, SONICBOOM, THUNDER_WAVE
	db 33, AMPHAROS,   THUNDERPUNCH, COTTON_SPORE, IRON_TAIL, FIRE_PUNCH
	db 35, STEELIX,    EARTHQUAKE, SHARPEN, ROCK_THROW, IRON_TAIL
	db -1 ; end

ChuckGroup:
	; CHUCK (1)
	db "CHUCK@", TRAINERTYPE_MOVES
	db 27, PRIMEAPE,   BEAT_UP, RAGE, KARATE_CHOP, FURY_SWIPES
	db 27, HITMONLEE,  ROLLING_KICK, ROCK_SMASH, THIEF, STRENGTH
	db 31, MACHOKE,    KARATE_CHOP, ROCK_THROW, FORESIGHT, VITAL_THROW
	db 31, HITMONTOP,  ROLLING_KICK, PURSUIT, RAPID_SPIN, TRIPLE_KICK
...
ClairGroup:
	...
	db 38, GYARADOS,   DRAGONBREATH, SURF, BITE, GUST
...
Rival1Group:
	...
	; RIVAL1 (7)
	db "?@", TRAINERTYPE_MOVES
	db 20, HAUNTER,    LICK, SPITE, HYPNOSIS, SMOG
	db 20, MAGNEMITE,  TACKLE, THUNDERSHOCK, SUPERSONIC, SONICBOOM
	db 20, ZUBAT,      LEECH_LIFE, RAGE, BITE, CONFUSE_RAY
	...
	db 30, HAUNTER,    LICK, HYPNOSIS, SMOG, SHADOW_BALL
	...
	db 36, MAGNETON,   THUNDERBOLT, SONICBOOM, THUNDER_WAVE, SWIFT
	db 36, GENGAR,     HYPNOSIS, SMOG, SHADOW_BALL, CONFUSE_RAY
	db 36, ALAKAZAM,   DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 38, MEGANIUM,   REFLECT, GIGA_DRAIN, POISONPOWDER, BODY_SLAM
	db -1 ; end
	...
	db 36, GENGAR,     HYPNOSIS, SMOG, SHADOW_BALL, CONFUSE_RAY
	db 36, ALAKAZAM,   DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 38, TYPHLOSION, MUD_SLAP, FLAMETHROWER, QUICK_ATTACK, DOUBLE_KICK
	db -1 ; end
	...
	db 36, GENGAR,     HYPNOSIS, SMOG, SHADOW_BALL, CONFUSE_RAY
	db 36, ALAKAZAM,   DISABLE, PSYBEAM, RECOVER, FUTURE_SIGHT
	db 38, FERALIGATR, RAGE, SURF, ROCK_SMASH, SLASH
	db -1 ; end
...
WillGroup:
	...
	db 43, GIRAFARIG,  PSYCHIC_M, AGILITY, BEAT_UP, ROCK_SMASH
	db 43, SLOWKING,   SURF, PSYCHIC_M, AMNESIA, FLAMETHROWER
	db 44, ESPEON,     PSYCHIC_M, BATON_PASS, SHADOW_BALL, GROWTH
	db 44, EXEGGUTOR,  REFLECT, LEECH_SEED, EGG_BOMB, PSYCHIC_M
	db 44, SLOWBRO,    CURSE, ROCK_SMASH, BODY_SLAM, PSYCHIC_M
	db 45, XATU,       RECOVER, DRILL_PECK, CONFUSE_RAY, PSYCHIC_M
	db -1 ; end
...
BrunoGroup:
	...
	db 45, HITMONCHAN, PURSUIT, ICE_PUNCH, DYNAMICPUNCH, MACH_PUNCH
	db 45, HERACROSS,  CROSS_CHOP, MEGAHORN, EARTHQUAKE, SWORDS_DANCE
	db 46, HITMONLEE,  CURSE, HEADBUTT, HI_JUMP_KICK, FORESIGHT
	db 46, POLIWRATH,  BELLY_DRUM, ICE_PUNCH, SUBMISSION, THIEF
	db 46, STEELIX,    IRON_TAIL, EARTHQUAKE, ROCK_SLIDE, CRUNCH
	db 47, MACHAMP,    ROCK_SLIDE, FIRE_PUNCH, VITAL_THROW, CROSS_CHOP
	db -1 ; end

KarenGroup:
	; KAREN (1)
	db "KAREN@", TRAINERTYPE_MOVES
	db 46, UMBREON,    CURSE, CONFUSE_RAY, FAINT_ATTACK, SCREECH
	db 46, VILEPLUME,  STUN_SPORE, ACID, MOONLIGHT, PETAL_DANCE
	db 47, GENGAR,     SHADOW_BALL, HYPNOSIS, DREAM_EATER, PSYCHIC_M
	db 47, MURKROW,    MUD_SLAP, DRILL_PECK, PURSUIT, FAINT_ATTACK
	db 47, HOUNDOOM,   ROAR, PURSUIT, FLAMETHROWER, CRUNCH
	db 48, TYRANITAR,  CRUNCH, EARTHQUAKE, ROCK_SLIDE, DRAGONBREATH
	db -1 ; end

KogaGroup:
	; KOGA (1)
	db "KOGA@", TRAINERTYPE_MOVES
	db 44, FORRETRESS, TOXIC, SPIKE_CANNON, EXPLOSION, SPIKES
	db 44, ARIADOS,    PURSUIT, TWINEEDLE, SLUDGE_BOMB, GIGA_DRAIN
	db 45, TENTACRUEL, SURF, SLUDGE_BOMB, ICE_BEAM, MEGA_DRAIN
	db 45, VENOMOTH,   LEECH_LIFE, SLUDGE_BOMB, PSYCHIC_M, SLEEP_POWDER
	db 45, MUK,        MINIMIZE, ACID_ARMOR, SLUDGE_BOMB, TOXIC
	db 46, CROBAT,     PURSUIT, SLUDGE_BOMB, WING_ATTACK, TOXIC
	db -1 ; end

ChampionGroup:
	; CHAMPION (1)
	db "LANCE@", TRAINERTYPE_MOVES
	db 47, GYARADOS,   CRUNCH, RAIN_DANCE, SURF, HYPER_BEAM
	db 47, ZAPDOS,     THUNDER, THUNDERBOLT, DRILL_PECK, HYPER_BEAM
	db 48, DRAGONITE,  THUNDER_WAVE, TWISTER, THUNDERBOLT, HYPER_BEAM
	db 48, DRAGONITE,  EXTREMESPEED, TWISTER, ICE_BEAM, HYPER_BEAM
	db 48, AERODACTYL, WING_ATTACK, ANCIENTPOWER, ROCK_SLIDE, HYPER_BEAM
	db 48, CHARIZARD,  FLAMETHROWER, WING_ATTACK, SLASH, HYPER_BEAM
	db 50, DRAGONITE,  FLAMETHROWER, SAFEGUARD, OUTRAGE, HYPER_BEAM
	db -1 ; end

BrockGroup:
	; BROCK (1)
	db "BROCK@", TRAINERTYPE_MOVES
	db 50, OMASTAR,    SPIKES, SURF, ANCIENTPOWER, SPIKE_CANNON
	db 50, GOLEM,      MEGA_PUNCH, ROCK_SLIDE, SANDSTORM, EARTHQUAKE
	db 50, RHYDON,     HEADBUTT, ROCK_SMASH, EARTHQUAKE, HORN_DRILL
	db 50, STEELIX,    IRON_TAIL, EARTHQUAKE, ROCK_SLIDE, CRUNCH
	db 50, KABUTOPS,   FURY_CUTTER, SURF, ANCIENTPOWER, GIGA_DRAIN
	db 50, TYRANITAR,  CRUNCH, EARTHQUAKE, ROCK_SLIDE, SANDSTORM
	db -1 ; end

MistyGroup:
	; MISTY (1)
	db "MISTY@", TRAINERTYPE_MOVES
	db 50, GOLDUCK,    SURF, DISABLE, HYPNOSIS, PSYCHIC_M
	db 50, QUAGSIRE,   SURF, AMNESIA, EARTHQUAKE, RAIN_DANCE
	db 50, LANTURN,    SURF, THUNDER, REST, SLEEP_TALK
	db 50, KINGLER,	   CRABHAMMER, METAL_CLAW, SLAM, SWORDS_DANCE
	db 50, LAPRAS,     SURF, REFLECT, ICE_BEAM, THUNDERBOLT
	db 50, STARMIE,    SURF, CONFUSE_RAY, RECOVER, ICE_BEAM
	db -1 ; end

LtSurgeGroup:
	; LT_SURGE (1)
	db "LT.SURGE@", TRAINERTYPE_MOVES
	db 50, ELECTRODE,  TOXIC, SPARK, REFLECT, EXPLOSION
	db 50, RAICHU,     THUNDER_WAVE, SURF, THUNDERBOLT, SUBMISSION
	db 50, JOLTEON,    THUNDERBOLT, GROWTH, BATON_PASS, AGILITY
	db 50, MAGNETON,   LOCK_ON, DOUBLE_TEAM, SWIFT, ZAP_CANNON
	db 50, ELECTABUZZ, ICE_PUNCH, THUNDERPUNCH, LIGHT_SCREEN, PURSUIT
	db -1 ; end
...
LassGroup:
	...
	; LASS (18) - STAUNEY
	db "STAUNEY@", TRAINERTYPE_MOVES
	db 10, PSYDUCK,	   CONFUSION, SCRATCH, FUTURE_SIGHT, DISABLE
	db 10, HOPPIP,     MEGA_DRAIN, LEECH_SEED, SLEEP_POWDER, SUNNY_DAY
	db 10, VULPIX,	   FLAME_WHEEL, HYPNOSIS, QUICK_ATTACK, ROAR
	db 10, JIGGLYPUFF, DOUBLESLAP, SING, DISABLE, POUND
	db 10, BUTTERFREE, LEECH_LIFE, CONFUSION, SLEEP_POWDER, GUST
	db 10, TOGEPI,     METRONOME, PRESENT, CHARM, FLASH
	db -1 ; end
