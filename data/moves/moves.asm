...
; entries correspond to move ids (see constants/move_constants.asm)
	...
	move BIND,         EFFECT_TRAP_TARGET,        15, NORMAL,        80, 20,   0
	...
	move BLIZZARD,     EFFECT_BLIZZARD,        	 120, ICE,           80, 10,  15
	...
	move HYPER_BEAM,   EFFECT_HYPER_BEAM,        150, NORMAL,        90, 10,   0
	...
	move RAZOR_LEAF,   EFFECT_NORMAL_HIT,         60, GRASS,         95, 25,   0
	...
	move SMOG,         EFFECT_POISON_HIT,         35, POISON,       100, 20,  30
	...
	move CLAMP,        EFFECT_TRAP_TARGET,        40, WATER,        100, 10,   0
	...
	move SKY_ATTACK,   EFFECT_SKY_ATTACK,        140, FLYING,        90, 10,   0
	move TRANSFORM,    EFFECT_TRANSFORM,           0, NORMAL,       100, 10,   0
	move BUBBLE,       EFFECT_SPEED_DOWN_HIT,     30, WATER,        100, 30,  20
	...
	move CRABHAMMER,   EFFECT_DEFENSE_DOWN,      100, WATER,         95, 10,   0
	...
	move ROCK_SLIDE,   EFFECT_FLINCH_HIT,         80, ROCK,          90, 10,  30
	...
	move FLAME_WHEEL,  EFFECT_FLAME_WHEEL,        60, FIRE,         100, 25,  15
	move SNORE,        EFFECT_SNORE,              45, NORMAL,       100, 15,  30
	...
	move COTTON_SPORE, EFFECT_SPEED_DOWN_2,        0, GRASS,         90, 40,   0
	move REVERSAL,     EFFECT_REVERSAL,            1, FIGHTING,     100, 15,   0
	move SPITE,        EFFECT_SPITE,               0, GHOST,        100, 10,   0
	move POWDER_SNOW,  EFFECT_FREEZE_HIT,         40, ICE,          100, 25,  15
	...
	move SLUDGE_BOMB,  EFFECT_POISON_HIT,         90, POISON,       100, 10,  20
	...
	move ZAP_CANNON,   EFFECT_PARALYZE_HIT,      100, ELECTRIC,      50, 10, 100
	...
	move FALSE_SWIPE,  EFFECT_FALSE_SWIPE,        45, NORMAL,       100, 40,   0
	...
	move STEEL_WING,   EFFECT_DEFENSE_UP_HIT,     65, STEEL,        100, 25,  20
	...
	move IRON_TAIL,    EFFECT_DEFENSE_DOWN_HIT,   90, STEEL,         95, 15,  25
	move METAL_CLAW,   EFFECT_ATTACK_UP_HIT,      65, STEEL,        100, 35,  20
	...
	move HIDDEN_POWER, EFFECT_HIDDEN_POWER,        1, NORMAL,       100, 20,   0
	move CROSS_CHOP,   EFFECT_NORMAL_HIT,        100, FIGHTING,      80, 10,   0
	move TWISTER,      EFFECT_TWISTER,            65, DRAGON,       100, 20,  25
	...
	move ANCIENTPOWER, EFFECT_ALL_UP_HIT,         60, ROCK,         100, 25,  10
	move SHADOW_BALL,  EFFECT_SP_DEF_DOWN_HIT,    80, GHOST,        100, 15,  20
	move FUTURE_SIGHT, EFFECT_FUTURE_SIGHT,      125, PSYCHIC_TYPE, 100, 15,   0
