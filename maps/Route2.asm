...
Route2_MapEvents:
	...
	warp_event  1, 33, VIRIDIAN_FOREST, 3
	warp_event  2, 33, VIRIDIAN_FOREST, 4
	...
	bg_event  8, 11, BGEVENT_ITEM, Route2HiddenMaxEther
	bg_event 14, 19, BGEVENT_ITEM, Route2HiddenFullHeal
	bg_event  5, 27, BGEVENT_ITEM, Route2HiddenFullRestore
	bg_event 13, 41, BGEVENT_ITEM, Route2HiddenRevive
	...
	object_event  1, 42, SPRITE_BUG_CATCHER, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, PAL_NPC_BROWN, OBJECTTYPE_TRAINER, 3, TrainerBugCatcherDoug, -1
	object_event  6, 32, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route2DireHit, EVENT_ROUTE_2_DIRE_HIT
	object_event  7, 11, SPRITE_POKE_BALL, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_ITEMBALL, 0, Route2MaxPotion, EVENT_ROUTE_2_MAX_POTION
	...
	object_event 19, 19, SPRITE_FRUIT_TREE, SPRITEMOVEDATA_STILL, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, Route2FruitTree, -1
