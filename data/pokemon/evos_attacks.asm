...
KadabraEvosAttacks:
	...
	db EVOLVE_LEVEL, 40, ALAKAZAM ; can now evolve through level up
	db 0 ; no more evolutions
	db 1, TELEPORT
	db 1, KINESIS
	db 1, CONFUSION
...
MachokeEvosAttacks:
	...
	db EVOLVE_LEVEL, 40, MACHAMP ; can now evolve through level up
	db 0 ; no more evolutions
	db 1, LOW_KICK
	db 1, LEER
	db 1, FOCUS_ENERGY
...
GravelerEvosAttacks:
	...
	db EVOLVE_LEVEL, 40, GOLEM ; can now evolve through level up
	db 0 ; no more evolutions
	db 1, TACKLE
	db 1, DEFENSE_CURL
	db 1, ROCK_THROW
